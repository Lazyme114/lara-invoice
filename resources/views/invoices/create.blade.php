						...
						<div class="container">
							<div class="row clearfix">
								<div class="col-md-4 offset-4 text-center">
									Invoice number *:
									<br />
									<input type="text" name="invoice[invoice_number]" placeholder="AA001" class="form-control" required>
									Invoice Date *:
									<br />
									<input type="text" name="invoice[invoice_date]" value="{{ date('Y-m-d') }}" class="form-control" required>
								</div>
							</div>
